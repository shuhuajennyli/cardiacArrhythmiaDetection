...
test_df.to_csv(r'/home/cst2020/ScienceFair/processedtest_df3.csv', header=None, index=None, sep=',', mode='a+')
train_df.to_csv(r'/home/cst2020/ScienceFair/processedtrain_df3.csv', header=None, index=None, sep=',', mode='a+')
validation_df.to_csv(r'/home/cst2020/ScienceFair/processedvalidation_df3.csv', header=None, index=None, sep=',', mode='a+')