...
for dirname, _, filenames in os.walk('/home/cst2020/ScienceFair/TestingFinalVersions/mitbih-database/mitbih_database'):
...
def process(wave, annotations):
	...
	processed = open("/home/cst2020/ScienceFair/TestingFinalVersions/processednew.csv", "a+")
