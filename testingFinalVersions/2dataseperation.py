...
df=pd.read_csv('/home/cst2020/ScienceFair/TestingFinalVersions/processednew.csv',header=None)
...
test_df.to_csv(r'/home/cst2020/ScienceFair/TestingFinalVersions/processedtest_df2.csv', header=None, index=None, sep=',', mode='a+')
train_df.to_csv(r'/home/cst2020/ScienceFair/TestingFinalVersions/processedtrain_df2.csv', header=None, index=None, sep=',', mode='a+')
validation_df.to_csv(r'/home/cst2020/ScienceFair/TestingFinalVersions/processedvalidation_df2.csv', header=None, index=None, sep=',', mode='a+')
