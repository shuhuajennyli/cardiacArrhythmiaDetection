...
def network(X_train,y_train,X_validation,y_validation):
    ...
    #ACTUAL DOUBLE DENSE HAS CALLBACK
    #callbacks = [EarlyStopping(monitor='val_loss', patience=8),
             #ModelCheckpoint(filepath='best_model.h5', monitor='val_loss', save_best_only=True)]

#CHANGE EPOCH TO 40
#removed callbacks=callbacks
    history=model.fit(X_train, y_train,epochs=1000, batch_size=100,validation_data=(X_validation,y_validation))
    model.load_weights('doubledense1000.h5')
...
model.save('doubledense1000.h5')

new=load_model('doubledense1000.h5')
