...
train_df=pd.read_csv('/home/cst2020/ScienceFair/processedtrain_df2.csv',header=None)
validation_df=pd.read_csv('/home/cst2020/ScienceFair/processedvalidation_df2.csv',header=None)
test_df=pd.read_csv('/home/cst2020/ScienceFair/processedtest_df2.csv',header=None)
...
def network(X_train,y_train,X_validation,y_validation):
    ...
    callbacks = [ModelCheckpoint(filepath='seperatefile2_1000newLRactual1dense.h5', monitor='val_loss', save_best_only=True)]

    #training the model and saving it to a file, and saving history for validation and loss graphs
    history=model.fit(X_train, y_train,epochs=1000, callbacks=callbacks, batch_size=100,validation_data=(X_validation,y_validation))
    model.load_weights('seperatefile2_1000newLRactual1dense.h5')
    model.save('seperatefile2_1000newLRactual1dense.h5')
